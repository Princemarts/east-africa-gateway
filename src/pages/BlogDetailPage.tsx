      ...
      <div className="min-h-screen bg-white">
        ...
        <main className="pt-20">
          <div className="container mx-auto px-6 py-24 text-center">
            <h1 className="text-3xl font-bold text-navy-primary mb-4">Post Not Found</h1>
            <Link to="/resources">
              ...
              <div className="prose prose-lg max-w-none">
                {post.content.split('\n').map((paragraph, index) => {
                  if (paragraph.startsWith('## ')) {
                    return (
                      <h2 key={index} className="text-2xl font-bold text-navy-primary mt-8 mb-4">
                        {paragraph.replace('## ', '')}
                      </h2>
                    );
                  }
                  if (paragraph.startsWith('**') && paragraph.endsWith('**')) {
                    return (
                      <h3 key={index} className="text-lg font-semibold text-navy-primary mt-6 mb-2">
                        {paragraph.replace(/\*\*/g, '')}
                      </h3>
                    );
                  }
